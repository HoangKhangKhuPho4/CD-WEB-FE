        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          ...
          >
            ...
            >
              {isLiked ? (
                <path
                  d="M8 14.4l-.9-.82C3.54 10.36 1.33 8.28 1.33 5.69c0-2.06 1.62-3.69 3.67-3.69 1.16 0 2.27.54 3 1.39.73-.85 1.84-1.39 3-1.39 2.05 0 3.67 1.63 3.67 3.69 0 2.59-2.21 4.67-5.77 7.89L8 14.4z"
                  fill="currentColor"
                />
              ) : (
                <path
