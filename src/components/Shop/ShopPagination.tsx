        ...
        <ul className="flex items-center flex-wrap gap-1">
          <li>
            <button
              ...
              disabled={page === 0}
              onClick={() => go(page - 1)}
              className="flex items-center justify-center w-8 h-9 ease-out duration-200 rounded-[3px] hover:text-white hover:bg-blue disabled:text-gray-4 disabled:hover:bg-transparent disabled:hover:text-inherit"
            >
            ...
            <li key={p}>
              <button
                ...
                className={`flex py-1.5 px-3.5 duration-200 rounded-[3px] ${
                  p === page ? "bg-blue text-white" : "hover:text-white hover:bg-blue"
                }`}
              >
                {p + 1}
              </button>
