...
import CustomSelect, { type SelectOption } from "../ShopWithSidebar/CustomSelect";
import ShopPagination from "../Shop/ShopPagination";
import { EMPTY_SHOP_FILTERS, useShopCatalog, type ShopSortValue } from "../Shop/useShopCatalog";
...
const ShopWithoutSidebar = () => {
  ...
  const { products, page, setPage, totalElements, totalPages, loading, error, rangeLabel } =
    useShopCatalog(sortValue, EMPTY_SHOP_FILTERS);
